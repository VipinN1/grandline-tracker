...
function LeaderSearchInput({ label, placeholder, onSelect, selected, onClear }) {
  ...
  if (selected) {
    return (
      <div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(22,27,39,0.75)', border: '1px solid #8b5cf644', borderRadius: 8, padding: '8px 12px' }}>
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      {open && query.length >= 2 && (
        <div style={{ position: 'absolute', top: '100%', left: 0, right: 0, zIndex: 50, background: 'rgba(22,27,39,0.75)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, marginTop: 4, boxShadow: '0 8px 24px rgba(0,0,0,0.4)', maxHeight: 280, overflowY: 'auto' }}>
