    ...
    <div style={{ maxWidth: 720, margin: '0 auto', paddingTop: '3rem' }}>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <div style={CARD_STYLE}>
            <div style={{ fontSize: 22 }}>💬</div>
            <div style={{ fontSize: 15, fontWeight: 700, color: '#f0f2f5' }}>Community</div>
            <div style={{ fontSize: 13, color: '#7c6fa0', lineHeight: 1.5 }}>
              Browse decklists, tournament reports, and meta discussion. Sign in to post.
            </div>
            <button
          ...
          <div style={CARD_STYLE}>
            <div style={{ fontSize: 22 }}>🏪</div>
            <div style={{ fontSize: 15, fontWeight: 700, color: '#f0f2f5' }}>Marketplace</div>
            <div style={{ fontSize: 13, color: '#7c6fa0', lineHeight: 1.5 }}>
              Browse card listings with price and condition filters. Sign in to buy or sell.
            </div>
            <button
      ...
      {/* Auth CTA */}
      <div style={{ background: 'rgba(124,58,237,0.06)', border: '1px solid rgba(139,92,246,0.16)', borderRadius: 14, padding: 24 }}>
